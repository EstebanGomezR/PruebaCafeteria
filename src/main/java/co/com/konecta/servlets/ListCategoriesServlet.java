...
public class ListCategoriesServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        CRUDProduct sqlEvent = new CRUDProduct();
            ...
            try {
                categorias = sqlEvent.SearchAllCategories();
            ...
            request.getRequestDispatcher("venderProducto.jsp").forward(request, response);
    }
    ...
    public ArrayList obtainCategories() throws ClassNotFoundException{
        CRUDProduct sqlEvent = new CRUDProduct();
        return sqlEvent.SearchAllCategories();
